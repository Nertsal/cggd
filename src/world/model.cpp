			...
			for (size_t v = 0; v < fv; v++) {
				...
				if (index_map.count(idx_tuple) == 0) {
					...
					if (materials.size() > 0) {
						...
						vertex.emmisive_r = material.emission[0];
						vertex.emmisive_g = material.emission[1];
						vertex.emmisive_b = material.emission[2];
					}
